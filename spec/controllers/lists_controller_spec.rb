  ...
  describe "POST #create" do
    ...
    context "with valid params" do
      it "creates a new List" do
        expect {
          post :create, list: {title: "myList", description: "myDesc", user: user}
        }.to change(List, :count).by(1)
      end

      it "assigns a newly created list as @list" do
        post :create, {list: {title: "myList1", description: "myDesc1", user: user}}
        expect(assigns(:list)).to be_a(List)
        expect(assigns(:list)).to be_persisted
      end

      it "redirects to the created list" do
        post :create, {list: {title: "myList2", description: "myDesc2", user: user}}, valid_session
